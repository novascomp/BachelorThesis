...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf()
                .csrfTokenRepository(getCsrfTokenRepository()).ignoringAntMatchers("/simple", "/NVSNV/ENV/links/update").and()
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, "/DownloadServlet/byToken/**", "/shares/files/**/shares/**/download", "/", "/about", "/NVSNV/ENV/**").permitAll()
                .antMatchers(HttpMethod.POST, "/simple", "/NVSNV/ENV/links/update").permitAll()
                .anyRequest()
                .authenticated()
                .and()
