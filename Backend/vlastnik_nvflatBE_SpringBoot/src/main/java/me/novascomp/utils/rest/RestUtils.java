...
public class RestUtils {
    ...
    public static void verifyRecaptcha(String applicationMainScope, List<String> scopes, @NotNull String recaptchaToken, @NotNull String action, @NotNull float requiredTreshold) throws me.novascomp.utils.standalone.service.exceptions.SecurityException {
        if (!scopes.contains(applicationMainScope)) {
            try {
                ...
                throw new me.novascomp.utils.standalone.service.exceptions.SecurityException();
            }
        }
    }
}
