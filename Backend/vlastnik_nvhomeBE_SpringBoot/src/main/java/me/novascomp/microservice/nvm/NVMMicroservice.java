...
public class NVMMicroservice extends Microservice {
    ...
    public HttpResponse<String> createMessageComponent(@NotNull String organizationId, @NotNull String componentName, @NotNull String text) throws IOException, InterruptedException, ConnectException {
        LightweightComponent component = new LightweightComponent(text, organizationId);
