...
import me.novascomp.home.repository.UserRepository;
import me.novascomp.home.service.business.rules.UserCreateBusinessRule;
import me.novascomp.home.service.business.rules.UserUpdateBusinessRule;
...
public class UserService extends GeneralService<User, UserRepository, UserCreateBusinessRule, UserUpdateBusinessRule> {
    ...
    protected UserCreateBusinessRule getBusinessRuleCrudCreate(Requirement<UserCreateBusinessRule> requirement) {
        ...
        if (uid.isPresent()) {
            foundInDatabase = repository.existsByUid(uid.get());
        }
