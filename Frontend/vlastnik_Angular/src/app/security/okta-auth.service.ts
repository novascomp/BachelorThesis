...
export class OktaAuthService {
  ...
  CLIENT_ID = '0oa5teuzfHUuirdeZ5d6';
  ISSUER = 'https://dev-3407204.okta.com/oauth2/default';
  ...
  login(originalUrl) {
    ...
    this.oktaAuth.token.getWithRedirect({scopes: ['openid', 'email', 'profile'], responseMode: 'query', responseType: 'token'});
  }
